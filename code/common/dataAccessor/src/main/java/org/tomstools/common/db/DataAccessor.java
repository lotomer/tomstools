...
/**
 *  ClassName: DataAccessor Description: 数据访问接口 
 * 
 * @author: lotomer
 * @version: 1.0 Create at: 2010-7-29 下午02:11:32
 * 
...
public interface DataAccessor
{
    /**
     * 获取数据库连接
     *     正常使用时不需要单独调用此接口，只有在特殊情况下（如：兼容以前数据库操作代码）才需要调用此接口
     * @return 数据库连接
     */
    ...
    /**
     * 打开数据库连接
     * @param autoCommit  是否自动提交修改
     * @throws DAOException 打开失败
     */
    ...
    /**
     * 从数据库查询一条记录
     * @param sqlName SQL语句对应的名称
     * @return  一条结果记录对应的java对象
     * @throws DAOException 查询失败
     */
