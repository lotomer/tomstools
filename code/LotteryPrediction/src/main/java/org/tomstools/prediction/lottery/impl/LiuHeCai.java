 ...
 * @version 1.0
 */
public class LiuHeCai extends Lottery {
    private static final int[] maxValue4types = new int[] { 49}; // 各种球的最大值
    private static final int[] startIndex4types = new int[] { 0}; // 各种类分隔线的索引号
    private static final int numberCount = 1; // 每期开球个数
    ...
    public String toString() {
        ...
        builder.append("LiuHeCai [numberCount=").append(numberCount).append(", maxValue4types=")
